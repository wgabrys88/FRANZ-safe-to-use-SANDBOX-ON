...
You have task to draw a cat sketch using your tools, it must be resembling a picture of a real cat. You have a desktop, a keyboard, a mouse, and the consequences of your choices made visible to you each turn.

Write your narrative in a way that it will consider that the tools you are using may fail, this way you will learn which tool does what. 
